...
function AllCategories() {
  ...
  const nameBodyTemplate = (rowData) => (
    <div className="flex items-center gap-3 py-1">
      <div className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0 bg-gradient-to-br from-violet-400/20 to-fuchsia-500/20 border border-violet-500/30">
    ...
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 py-2">
      ...
      <div className="relative w-full sm:w-80">
        ...
        <InputText
          ...
          className="!w-full !bg-slate-800/60 !border-slate-700/60 !text-white placeholder:!text-slate-500 !rounded-xl !pl-10 !pr-4 !py-2.5 !text-sm focus:!border-violet-500/50 transition-all"
        />
      </div>
    </div>
  );
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
            <div>
              <button
                ...
                className="flex items-center gap-1.5 text-violet-400 hover:text-violet-300 mb-4 text-sm font-medium transition-colors"
              >
                <ArrowLeft size={16} />
                Back to Dashboard
              </button>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-white text-sm uppercase tracking-wider bg-gradient-to-r from-violet-600 via-fuchsia-600 to-orange-500 hover:shadow-[0_10px_40px_rgba(139,92,246,0.4)] transition-all"
            >
          ...
          <div className="card-glass rounded-2xl p-5 sm:p-7">
            {!loading && categories.length === 0 ? (
              <div className="text-center py-16">
                ...
                <button
                  onClick={() => navigate("/categories/create")}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-violet-600 to-fuchsia-600"
                >
                  Add Category
                </button>
              </div>
